...
function Teste5({navigation}){
  ...
  function vencedor (){
    setWin('Você Acertou!Evite Supermercados!')
    setLos('') 
    } 
  ...
  function vencedor1 (){
    setWin1('Você Acertou! Evite esses locais!')
    setLos1('') 
    } 
  ...
  function vencedor2 (){
    setWin2('Você Acertou! Feiras Orgânicas !!')
    setLos2('') 
    } 
    ...
    <>
     <ScrollView>
      <View style={styles.container}>
         <Image source={require('../../assets/super.jpg')} style={styles.logo} />
           <Text style={styles.titulo}>
           Esse local é bom para fazer as compras ??</Text>
       ...
       <Image source={require('../../assets/feira.jpeg')} style={styles.logo} />
           <Text style={styles.titulo}>
           Esse local é bom para fazer as compras ??</Text>
       ...
       <Image source={require('../../assets/super1.jpg')} style={styles.logo} />
           <Text style={styles.titulo}>
           Esse local é bom para fazer as compras ??</Text>
