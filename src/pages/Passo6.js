...
function Passo6({navigation}){
    ...
    return (
      ...
      <View style={styles.container}>
        <Text style={styles.titulo}>  Fazer compras em locais
que ofertem variedades de alimentos in natura
ou minimamente processados </Text>
        <Text style={styles.titulo1}>      Procure fazer compras de alimentos em mercados, feiras livres e
...
preferência diretamente dos produtores. 
        ...
        <Image source={require('../../assets/feira.jpeg')} style={styles.logo1} />
              <Text style={styles.titulo2}>Feira Livre Orgânica</Text>

              <Image source={require('../../assets/feira1.jpeg')} style={styles.logo1} />
