...
function Passo3({navigation}){
    // const githubUsername = navigation.getParam('github_username');
    return (
      <>
      <ScrollView>
      <View style={styles.container}>
        <Text style={styles.titulo}>  Limitar o consumo
de alimentos processados</Text>
        <Text style={styles.titulo1}>      Os ingredientes e métodos usados na fabricação de alimentos
        ...
        <Image source={require('../../assets/pro.jpg')} style={styles.logo1} />
              <Text style={styles.titulo2}>Alimentos Enlatados</Text>

              <Image source={require('../../assets/conservas.jpg')} style={styles.logo1} />
              <Text style={styles.titulo2}>Alimentos em Conservas</Text>

              <Image source={require('../../assets/pao.jpg')} style={styles.logo1} />
              <Text style={styles.titulo2}>Pães </Text>

              <Image source={require('../../assets/queijo.jpg')} style={styles.logo1} />
              <Text style={styles.titulo2}>Queijos</Text>
      ...
      <View style={styles.container3}>        
        <TouchableOpacity onPress={() => navigation.navigate('Passo2')}>
         ...
         <TouchableOpacity onPress={() => navigation.navigate('Passo4')}>
            <Text style={styles.botao2}>4º Passo </Text>
         </TouchableOpacity>
         </View>
      </>
    );
