...
function Passo8({navigation}){
    ...
    return (
      ...
      <View style={styles.container}>
        <Text style={styles.titulo}>  Planejar o uso do tempo para dar à
alimentação o espaço que ela merece</Text>
        <Text style={styles.titulo1}>      Planeje as compras de alimentos, organize a despensa doméstica
e defina com antecedência o cardápio da semana. Divida com os membros de sua família a responsabilidade por todas as
...
espaço para a alimentação. 
        ...
        <Image source={require('../../assets/dispe.jpg')} style={styles.logo1} />
              <Text style={styles.titulo2}>Despensa Organizada</Text>

              <Image source={require('../../assets/dispe1.jpg')} style={styles.logo1} />
