...
function Teste4({navigation}){
  ...
  function vencedor (){
    setWin('Você Acertou!! Evite "Beslicar"!!')
    setLos('') 
    } 
  ...
  function vencedor1 (){
    setWin1('Você Acertou!! Evite Fastfoods !!')
    setLos1('') 
    } 
  ...
  function vencedor2 (){
    setWin2('Você Acertou! Bom ambiente!!')
    setLos2('')  
    } 
    ...
    <>
     <ScrollView>
      <View style={styles.container}>
         <Image source={require('../../assets/lanche.jpg')} style={styles.logo} />
           <Text style={styles.titulo}>
           Esse ambiente é apropriado para fazer uma refeição ??           </Text>
       ...
       <Image source={require('../../assets/janta.jpg')} style={styles.logo} />
           <Text style={styles.titulo}>
           Esse ambiente é apropriado para fazer uma refeição ??
           </Text>
       ...
       <Image source={require('../../assets/mc.jpg')} style={styles.logo} />
           <Text style={styles.titulo}>
           Esse ambiente é apropriado para fazer uma refeição ?? 
           </Text>
