...
function Teste7({navigation}){
  ...
  function vencedor (){
    setWin('Você Acertou!Organize a Despensa!')
    setLos('') 
    } 
  ...
  function vencedor1 (){
    setWin1('Você Acertou!Organize a Cozinha!')
    setLos1('') 
    } 
  ...
  function vencedor2 (){
    setWin2('Você Acertou!Despensa Organizada!')
    setLos2('') 
    } 
    ...
    <>
     <ScrollView>
      <View style={styles.container}>
         <Image source={require('../../assets/despz.jpg')} style={styles.logo} />
           <Text style={styles.titulo}>
           Esse local está apropriado para cozinhar??</Text>
       ...
       <Image source={require('../../assets/dispe.jpg')} style={styles.logo} />
           <Text style={styles.titulo}>
           Esse local está apropriado para cozinhar??</Text>
       ...
       <Image source={require('../../assets/despz1.jpg')} style={styles.logo} />
           <Text style={styles.titulo}>
           Esse local está apropriado para cozinhar??</Text>
