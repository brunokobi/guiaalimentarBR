...
function Passo7({navigation}){
    ...
    return (
      ...
      <View style={styles.container}>
        <Text style={styles.titulo}>  Desenvolver, exercitar
e partilhar habilidades culinárias</Text>
        <Text style={styles.titulo1}>      Se você tem habilidades culinárias, procure desenvolvê-las e partilhálas, principalmente com crianças e jovens, sem distinção de gênero.
...
cozinhar!  
        ...
        <Image source={require('../../assets/cozinhar.jpg')} style={styles.logo1} />
              <Text style={styles.titulo2}>Cozinhar em Casa</Text>

              <Image source={require('../../assets/cozinhar1.jpg')} style={styles.logo1} />
