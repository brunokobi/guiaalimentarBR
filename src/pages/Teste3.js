...
function Teste3({navigation}){
  ...
  function vencedor (){
    setWin('Você Acertou!! Coma à vontade!!')
    setLos('') 
    } 
  ...
  function vencedor1 (){
    setWin1('Você Acertou!! Limite o consumo!!')
    setLos1('') 
    } 
  ...
  function vencedor2 (){
    setWin2('Você Acertou !! Evite o consumo!! ')
    setLos2('') 
    } 
    ...
    <>
     <ScrollView>
      <View style={styles.container}>
         <Image source={require('../../assets/farinhas.jpg')} style={styles.logo} />
           <Text style={styles.titulo}>
           Esse alimento deve ter seu consumo evitado ??           </Text>
       ...
       <Image source={require('../../assets/biscoito.jpg')} style={styles.logo} />
           <Text style={styles.titulo}>
           Esse alimento deve ter seu consumo evitado ?? 
           </Text>
       ...
       <Image source={require('../../assets/queijo.jpg')} style={styles.logo} />
           <Text style={styles.titulo}>
           Esse alimento deve ter seu consumo evitado ?? 
           </Text>
