...
function Teste({navigation}){
    ...
    function vencedor (){
      setWin('Você Acertou !! Pode comer !!')
      setLos('') 
      } 
    ...
    function vencedor1 (){
      setWin1('Você Acertou !! Pode comer !!')
      setLos1('') 
      } 
    ...
    function vencedor2 (){
      setWin2('Você Acertou !! Deve evitar!! ')
      setLos2('') 
      } 
        ...
        <View style={styles.container}>
           <Image source={require('../../assets/innatura.jpg')} style={styles.logo} />
             <Text style={styles.titulo}>
               Qual é a classificação desses alimentos??
             </Text>
           <TouchableOpacity onPress={vencedor}>
            <Text style={styles.botao2}> InNatura </Text>
         </TouchableOpacity>
         <TouchableOpacity onPress={perde}>
            <Text style={styles.botao3}> Processado </Text>
         </TouchableOpacity>
         <TouchableOpacity onPress={perde}>
            <Text style={styles.botao4}> Ultraprocessado </Text>
         </TouchableOpacity>
         <Text style={styles.titulo2}> {win} {los}</Text>        

         <Image source={require('../../assets/batata.jpg')} style={styles.logo} />
             <Text style={styles.titulo}>
               Qual é a classificação desses alimentos??
             </Text>
         ...
         <Image source={require('../../assets/graos.jpg')} style={styles.logo} />
             <Text style={styles.titulo}>
               Qual é a classificação desses alimentos??
             </Text>
