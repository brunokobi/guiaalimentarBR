...
function Passo5({navigation}){
    // const githubUsername = navigation.getParam('github_username');
    return (
      <>
      <ScrollView>
      <View style={styles.container}>
        <Text style={styles.titulo}>  Comer com regularidade e atenção,
em ambientes apropriados e, sempre que
possível, com companhia </Text>
        <Text style={styles.titulo1}>      Procure fazer suas refeições em horários semelhantes todos os dias e
...
colegas de trabalho ou escola. A companhia nas refeições favorece o
comer com regularidade e atenção, combina com ambientes apropriados
...
domésticas que antecedem ou sucedem o consumo das refeições.
             ...
             <Image source={require('../../assets/janta.jpg')} style={styles.logo1} />
              <Text style={styles.titulo2}>Refeições com os Amigos</Text>

              <Image source={require('../../assets/janta1.jpg')} style={styles.logo1} />
              <Text style={styles.titulo2}>Refeições com a Família</Text>
              
              

              <TouchableOpacity onPress={() => navigation.navigate('Teste4')}>
