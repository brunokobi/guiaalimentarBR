...
function Teste6({navigation}){
  ...
  function vencedor2 (){
    setWin2('Você Acertou! Cozinhar em Casa !')
    setLos2('') 
    } 
    ...
    <>
     <ScrollView>
      <View style={styles.container}>
         <Image source={require('../../assets/conge.jpg')} style={styles.logo} />
           <Text style={styles.titulo}>
           Essa é a melhor maneira de preparar as refeições ??</Text>
       ...
       <Image source={require('../../assets/cozinhar.jpg')} style={styles.logo} />
           <Text style={styles.titulo}>
           Essa é a melhor maneira de preparar as refeições ??</Text>
       ...
       <Image source={require('../../assets/conge1.jpg')} style={styles.logo} />
           <Text style={styles.titulo}>
           Essa é a melhor maneira de preparar as refeições ??</Text>
