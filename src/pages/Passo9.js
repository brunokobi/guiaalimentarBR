...
function Passo9({navigation}){
    ...
    return (
      ...
      <View style={styles.container}>
        <Text style={styles.titulo}>  Dar preferência,
quando fora de casa, a locais
que servem refeições feitas na hora</Text>
        <Text style={styles.titulo1}>      No dia a dia, procure locais que servem refeições feitas na hora e a
...
local de trabalho. Evite redes de fast-food  
        ...
        <Image source={require('../../assets/rest.jpg')} style={styles.logo1} />
              <Text style={styles.titulo2}>Self Service</Text>

              <Image source={require('../../assets/rest1.jpg')} style={styles.logo1} />
