...
function Teste8({navigation}){
  ...
  function vencedor (){
    setWin('Você Acertou! Evite FastFoods!')
    setLos('') 
    } 
  ...
  function vencedor2 (){
    setWin2('Você Acertou!! Self Service !!')
    setLos2('') 
    } 
     ...
     <ScrollView>
      <View style={styles.container}>
         <Image source={require('../../assets/lanche.jpg')} style={styles.logo} />
           ...
           Esse local é bom para comer fora de casa??</Text>
       ...
       <Image source={require('../../assets/rest.jpg')} style={styles.logo} />
           <Text style={styles.titulo}>
           Esse local é bom para comer fora de casa??</Text>
