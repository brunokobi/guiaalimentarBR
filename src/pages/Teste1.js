...
function Teste1({navigation}){
    ...
    function vencedor (){
      setWin('Você Acertou !! Deve evitar!!')
      setLos('') 
      } 
    ...
    function vencedor1 (){
      setWin1('Você Acertou !! Não pode comer !!')
      setLos1('') 
      } 
    ...
    function vencedor2 (){
      setWin2('Você Acertou !! Evite excesso!! ')
      setLos2('') 
      } 
       ...
       <ScrollView>
        <View style={styles.container}>
           <Image source={require('../../assets/biscoito.jpg')} style={styles.logo} />
             ...
             Esse alimento pode ser consumido em pequenas quantidades ??
             </Text>
         ...
         <Image source={require('../../assets/sal.jpg')} style={styles.logo} />
             <Text style={styles.titulo}>
             Esse alimento pode ser consumido em pequenas quantidades ??
             </Text>
         ...
         <Image source={require('../../assets/miojo.jpg')} style={styles.logo} />
             <Text style={styles.titulo}>
               Esse alimento pode ser consumido em pequenas quantidades ??
             </Text>
