...
function Teste2({navigation}){
  ...
  function vencedor1 (){
    setWin1('Você Acertou!! Coma à vontade!!')
    setLos1('') 
    } 
    ...
    <>
     <ScrollView>
      <View style={styles.container}>
         <Image source={require('../../assets/frutas.jpg')} style={styles.logo} />
           <Text style={styles.titulo}>
           Esse alimento deve ter seu consumo limitado ??           </Text>
       ...
       <Image source={require('../../assets/pro.jpg')} style={styles.logo} />
           <Text style={styles.titulo}>
           Esse alimento deve ter seu consumo limitado ??
           </Text>
       ...
       <Image source={require('../../assets/verduras.jpg')} style={styles.logo} />
           <Text style={styles.titulo}>
             Esse alimento deve ter seu consumo limitado ??
           </Text>
