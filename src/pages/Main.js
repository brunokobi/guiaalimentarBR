 ...
 function Main( {navigation}) {  
  ...
  return (
    <>
     ...
     <Text style={styles.titulo1}>10 passos para uma Alimentação Adequada e Saudável
     </Text>     
      <Container>
        <TabsContainer>
      ...
      {/* <Image source={require('../../assets/seta.gif')} style={styles.logo2} /> */}
    ...
    <View style={styles.container} >
        ...
        <Container1>
          <TabsContainer1>
          <TabItemG>
          <TouchableOpacity onPress={() => navigation.navigate('InNatura')}>                
                <TabText1>In Natura</TabText1> 
            </TouchableOpacity>

            <TouchableOpacity onPress={() => navigation.navigate('MinProcessado')}>              
                <TabText1>Minimamente
                Processados</TabText1>
            </TouchableOpacity>
            </TabItemG>
            {/* <TouchableOpacity onPress={() => navigation.navigate('InNatura')}>
              <TabItemG>
                <TabText>In Natura</TabText>
              </TabItemG>
            </TouchableOpacity>

            <TouchableOpacity onPress={() => navigation.navigate('MinProcessado')}>
              <TabItemG>
                <TabText>Minimamente</TabText>
                <TabText>Processados</TabText>
              </TabItemG>
            </TouchableOpacity> */}

            <TouchableOpacity onPress={() => navigation.navigate('Processado')}>
              <TabItemY>                
                <TabTextB>Processados</TabTextB>
              </TabItemY>
            </TouchableOpacity>

            <TouchableOpacity onPress={() => navigation.navigate('UltraProcessado')}>
              <TabItemR>               
         ...
         {/* <TouchableOpacity onPress={() => navigation.navigate('InNatura')}>
            <Text style={styles.botao}> * In Natura </Text>
         </TouchableOpacity>
         
         <TouchableOpacity onPress={() => navigation.navigate('MinProcessado')}>
         <Text style={styles.botao}> * Minimamente processados </Text>
         </TouchableOpacity>

         <TouchableOpacity onPress={() => navigation.navigate('Processado')}>
         <Text style={styles.botao}> * Processados </Text>
         </TouchableOpacity>

         <TouchableOpacity onPress={() => navigation.navigate('UltraProcessado')}>
         <Text style={styles.botao}> * Ultraprocessados </Text>
         </TouchableOpacity> */}
<Text></Text>
<Text></Text>
<Text></Text>
