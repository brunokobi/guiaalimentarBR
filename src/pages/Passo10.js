...
function Passo10({navigation}){
    ...
    return (
      ...
      <View style={styles.container}>
        <Text style={styles.titulo}>  Ser crítico quanto a
informações, orientações e mensagens sobre
alimentação veiculadas em propagandas
comerciais
</Text>
        <Text style={styles.titulo1}>      Lembre-se de que a função essencial da publicidade é aumentar a
...
crianças e jovens, a fazerem o mesmo.   
        ...
        <Image source={require('../../assets/prog.jpg')} style={styles.logo1} />
              <Text style={styles.titulo2}>Propaganda de Suco</Text>

              <Image source={require('../../assets/prog1.jpg')} style={styles.logo1} />
